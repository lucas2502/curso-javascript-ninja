(function(win,doc){
  ...
  */
  ...
  function calculateAllValues(accumulated, actual) {
      ...
      var lastOperator = getLestOperator(value);
      return doOperation(opetator, firstValue, lastValue) + lastOperator;
   }

   function getLestOperator(value){
    return isLastItemAnOperation(value) ? value.split('').pop() : '';
   }

   function doOperation(opetator, firstValue, lastValue){
    switch(operator) {
        case '+':
